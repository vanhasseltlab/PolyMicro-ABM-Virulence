...
all_species_all_virulence = [[['Low', 'Low', 'None'],['None', 'Low', 'None']],
                             [['Medium', 'Medium', 'None'],['None', 'Low', 'None']],
                             [['High', 'High', 'None'],['None', 'Low', 'None']],
                             [['Low', 'Low', 'None'],['None', 'Medium', 'None']],
                             [['Medium', 'Medium', 'None'],['None', 'Medium', 'None']],
                             [['High', 'High', 'None'],['None', 'Medium', 'None']],
                             [['Low', 'Low', 'None'],['None', 'High', 'None']],
                             [['Medium', 'Medium', 'None'],['None', 'High', 'None']],
...
folder_name = "/20_Antibiotic_A2_B1s_p1" 
