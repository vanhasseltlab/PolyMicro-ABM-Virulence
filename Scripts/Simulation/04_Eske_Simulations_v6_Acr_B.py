...
File Description: Simulation script for a dualspecies population. Species A posseses 2 virulence factors (vc and vr) and species B is avirulent
"""
...
virulence_types_A = ['cellbound','recruit']
virulence_types_B = []
