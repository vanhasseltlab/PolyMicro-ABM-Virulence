...
all_species_all_virulence = [[['High', 'None', 'High'],['None', 'Low', 'None']],
                             [['Medium', 'None', 'Medium'],['None', 'Medium', 'None']],
                             [['High', 'None', 'High'],['None', 'Medium', 'None']],
                             [['High', 'None', 'High'],['None', 'High', 'None']]
                             ]
...
folder_name = "/20_Antibiotic_A2_B1s_p2" 
