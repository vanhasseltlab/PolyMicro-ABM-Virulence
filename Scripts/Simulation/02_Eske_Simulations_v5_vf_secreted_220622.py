...
File Description: Simulation script for virulence factor secreted (vs) with a range of virulence strengths in a monospecies population
"""
...
### SPECIES A ###
vf_phag_surface = [0]#, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1] # virulence molecule on bacterial cell surface which inhibits neutrophil phagocytosis
vf_phag_excreted = [0.000, 0.010, 0.015, 0.020, 0.025, 0.030, 0.035, 0.040, 0.045, 0.050, 0.055, 0.060, 0.065, 0.070, 0.075]#, 0.055, 0.06, 0.065, 0.07, 0.075, 0.08, 0.085, 0.09, 0.095, 0.1]] # virulence molecule excreted by bacterial cell which inhibits neutrophil phagocytosis
vf_recruit = [0]#, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1] # virulence molecules excreted by bacterial cell that affects process of recruitment of host immune cells
...
if len(all_species) == 2:
    ...
    vf_recruit = [1] # virulence molecules excreted by bacterial cell that affects process of recruitment of host immune cells
...
folder_name="220622_vf_secreted"  
