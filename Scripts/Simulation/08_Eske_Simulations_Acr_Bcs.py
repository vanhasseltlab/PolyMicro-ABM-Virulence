...
File Description: Simulation script for a dualspecies population. Species A posseses 2 virulence factors (vc and vr) and species B posseses 2 virulence factors (vc and vs).
"""
