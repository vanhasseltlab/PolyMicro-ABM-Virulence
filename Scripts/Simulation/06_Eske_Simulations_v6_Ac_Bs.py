...
File Description: Simulation script for a dualspecies population. Species A posseses 1 virulence factors (vc) and species B posseses 1 virulence factors (vs).
"""
...
virulence_types_A = ['cellbound']
virulence_types_B = ['secreted']
...
#all_species_all_virulence.append([species_A_strength,all_species_all_strengths[1][0]])
#%%  
#-----------------------------------------------------------------------------------------------------------------------
