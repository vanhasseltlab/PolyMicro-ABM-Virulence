...
File Description: Simulation script for a dualspecies population during antibiotic treatment. Species A posseses 3 virulence factors (vc, vs and vr) and species B is avirulent.
"""
...
all_species_all_virulence = [[['None', 'High', 'None'],['None', 'None', 'None']],
                             [['Low', 'Low', 'None'],['None', 'None', 'None']],
                             [['Medium', 'Medium', 'None'],['None', 'None', 'None']],
                             [['High', 'High', 'None'],['None', 'None', 'None']],
                             [['None', 'High', 'High'],['None', 'None', 'None']],
                             [['Low', 'Low', 'Low'],['None', 'None', 'None']],
                             [['Medium', 'Medium', 'Medium'],['None', 'None', 'None']],
...
folder_name = "/20_Antibiotic_A123_B0"  
