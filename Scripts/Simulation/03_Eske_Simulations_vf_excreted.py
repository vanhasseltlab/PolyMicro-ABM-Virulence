...
File Description: Simulation script for virulence factor secreted (vs) with a range of virulence strengths in a dualspecies population
"""
...
folder_name="220612_03_vf_excreted"  
