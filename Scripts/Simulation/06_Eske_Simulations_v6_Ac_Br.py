...
File Description: Simulation script for a dualspecies population. Species A posseses 1 virulence factors (vc) and species B posseses 1 virulence factors (vr).
"""
