...
File Description: Simulation script for a dualspecies population. Species A posseses 2 virulence factors (vs and vr) and species B is avirulent
"""
...
virulence_types_A = ['secreted','recruit']
virulence_types_B = []
...
folder_name="220623_A-sec+rec_B-"  
