...
File Description: Simulation script for a dualspecies population. Species A posseses 2 virulence factors (vc and vs) and species B posseses 2 virulence factors (vc and vs).
"""
...
virulence_types_A = ['cellbound','secreted']
