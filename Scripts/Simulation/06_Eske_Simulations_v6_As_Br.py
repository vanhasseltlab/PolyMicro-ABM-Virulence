...
File Description: Simulation script for a dualspecies population. Species A posseses 1 virulence factors (vs) and species B posseses 1 virulence factors (vr).
"""
import os
import pickle
...
virulence_types_A = ['secreted']
virulence_types_B = ['recruit']
...
folder_name="220623_A-sec_B-rec"  
