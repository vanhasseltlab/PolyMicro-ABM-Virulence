...
all_species_all_virulence = [[['Low', 'Low', 'None'],['Low', 'None', 'None']],
                             [['Medium', 'Medium', 'None'],['Low', 'None', 'None']],
                             [['High', 'High', 'None'],['Low', 'None', 'None']],
                             [['Low', 'Low', 'None'],['Medium', 'None', 'None']],
                             [['Medium', 'Medium', 'None'],['Medium', 'None', 'None']],
                             [['High', 'High', 'None'],['Medium', 'None', 'None']],
                             [['Low', 'Low', 'None'],['High', 'None', 'None']],
                             [['Medium', 'Medium', 'None'],['High', 'None', 'None']],
                             [['High', 'High', 'None'],['High', 'None', 'None']]
                             ]
...
folder_name = "/20_Antibiotic_A2_B1c_p1"  
