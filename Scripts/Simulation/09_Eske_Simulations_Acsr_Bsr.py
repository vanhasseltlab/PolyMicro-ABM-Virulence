...
File Description: Simulation script for a dualspecies population. Species A posseses 3 virulence factors (vc, vs and vr) and species B posseses 2 virulence factors (vs and vr).
"""
...
virulence_types_B = ['secreted','recruit']
...
folder_name = "/220705_09_Acsr_Bsr"  
