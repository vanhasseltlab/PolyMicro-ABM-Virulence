...
all_species_all_virulence = [[['None', 'High', 'High'],['None', 'None', 'Medium']],
                             [['None', 'Low', 'Low'],['None', 'None', 'High']],
                             [['None', 'Medium', 'Medium'],['None', 'None', 'High']],
                             [['None', 'High', 'High'],['None', 'None', 'High']]
                             ]
...
folder_name = "/20_Antibiotic_A2_B1r_p2" 
