...
File Description: Simulation script for a dualspecies population. Species A posseses 2 virulence factors (vr and vs) and species B posseses 1 virulence factors (vr).
"""
