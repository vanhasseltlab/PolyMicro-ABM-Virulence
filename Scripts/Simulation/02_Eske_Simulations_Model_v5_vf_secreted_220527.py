...
path = "C:/Users/eskev/Documents/Bio-Pharmaceutical Sciences - LU/Jaar 1/Research Project 1/RP1_GitHub/polymicroABM/Models Eske"
os.chdir(path)
...
vf_recruit = [1] #0.95, 0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6, 0.55, 0.5, 0.45, 0.4, 0.35, 0.3, 0.25, 0.2, 0.15, 0.1, 0.05, 0] # virulence molecules excreted by bacterial cell that affects process of recruitment of host immune cells
...
if len(all_species) == 2:
    ...
    all_species_all_virulence = [[virulence_A_vector[i], virulence_B_vector[i]] for i in range(len(virulence_A_matrix))]
...
folder_name="220527_vf_excreted"  
